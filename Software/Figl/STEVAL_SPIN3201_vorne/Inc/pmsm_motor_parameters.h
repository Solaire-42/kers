...
#define MOTOR_MAX_SPEED_RPM     972 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  21.0 /*!< Volts RMS ph-ph /kRPM */
#define NOMINAL_CURRENT_A       14

#define ID_DEMAG_A              -14 /*!< Demagnetization current */
