...
#define LS                      0.00034 /* Stator inductance, H
...
#define MOTOR_VOLTAGE_CONSTANT  36.0 /*!< Volts RMS ph-ph /kRPM */
#define NOMINAL_CURRENT_A       15

#define ID_DEMAG_A              -15 /*!< Demagnetization current */
