...
#define PHASE1_FINAL_CURRENT_A              0

/* Phase 2 */
#define PHASE2_DURATION                     1000 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (0*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              0

/* Phase 3 */
#define PHASE3_DURATION                     3000 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (100*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              10

/* Phase 4 */
#define PHASE4_DURATION                     3000 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (500*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              10

/* Phase 5 */
#define PHASE5_DURATION                     4000 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (955*SPEED_UNIT/U_RPM)
