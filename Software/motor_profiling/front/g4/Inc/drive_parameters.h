...
#define PID_TORQUE_KP_DEFAULT               3805
#define PID_TORQUE_KI_DEFAULT               1855
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3805
#define PID_FLUX_KI_DEFAULT                 1855
...
#define PID_SPEED_KP_DEFAULT                3302/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                123/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            800
