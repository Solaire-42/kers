...
#define PLL_KP_GAIN                         665
#define PLL_KI_GAIN                         59
...
#define PID_TORQUE_KP_DEFAULT               3044
#define PID_TORQUE_KI_DEFAULT               2174
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3044
#define PID_FLUX_KI_DEFAULT                 2174
...
#define PID_SPEED_KP_DEFAULT                2985/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                2100/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V              43 /*!< Over-voltage threshold */
...
#define PHASE1_FINAL_CURRENT_A              14

/* Phase 2 */
#define PHASE2_DURATION                     5000 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (200*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              14

/* Phase 3 */
#define PHASE3_DURATION                     10000 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (500*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              14

/* Phase 4 */
#define PHASE4_DURATION                     15000 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (800*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              14

/* Phase 5 */
#define PHASE5_DURATION                     20000 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (1000*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              14
